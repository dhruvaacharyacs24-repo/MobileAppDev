    ...
    <GradientScreen>
      ...
      >
        <Animated.View entering={FadeInDown.duration(500)}>
          ...
          >
            <Text className="text-xs uppercase tracking-widest text-cyan-200">
              SkillSync AI
            </Text>
            ...
            <Text className="mt-1 text-slate-300">
              Personalized analysis, real-time demand,
              actionable roadmap.
            </Text>
          </LinearGradient>
          ...
          <GlassCard>
            <View className="mb-5">
              ...
              <Text className="text-slate-400">
                Sign in to continue your AI-driven career
                journey.
              </Text>
            </View>
            ...
            {authError ? (
              <Text className="mb-4 text-sm text-rose-300">
                {authError}
              </Text>
            ) : null}
